...
Number_data<-list()
Number_data[[1]]<-list()
Number_data[[1]][[1]]<-"potential_p1"
Number_data[[1]][[2]]<-length(potential_p1)
Number_data[[1]][[3]]<-potential_p1



Number_data[[2]]<-list()
Number_data[[2]][[1]]<-"hs2002_code_upstream"
Number_data[[2]][[2]]<-length(Hidden_net$hs2002_code_upstream)
Number_data[[2]][[3]]<-unique(Hidden_net$hs2002_code_upstream)



Number_data[[3]]<-list()
Number_data[[3]][[1]]<-"hs2002_code_downstream"
Number_data[[3]][[2]]<-length(Hidden_net$hs2002_code_downstream)
Number_data[[3]][[3]]<-unique(Hidden_net$hs2002_code_downstream)
...
in_degree_values <- degree(g, mode = "in")


names(out_degree_values)
names(in_degree_values)
...
Number_data[[4]]<-list()
Number_data[[4]][[1]]<-"V(g_weighted)$name"
Number_data[[4]][[2]]<-length(V(g_weighted)$name)
Number_data[[4]][[3]]<-unique(V(g_weighted)$name)
...
Number_data[[5]]<-list()
Number_data[[5]][[1]]<-"V(g_weighted)$name_after_selection"
Number_data[[5]][[2]]<-length(V(g_weighted)$name)
Number_data[[5]][[3]]<-unique(V(g_weighted)$name)
...
Number_data[[6]]<-list()
Number_data[[6]][[1]]<-"build_k_input_subgraph"
Number_data[[6]][[2]]<-length(V(gplus)$name)
Number_data[[6]][[3]]<-unique(V(gplus)$name)
...
Data_to_send<-get.edgelist(g_tree)
colnames(Data_to_send)<-c("Source","Target")


write.csv(Data_to_send, file = "Data_to_send.csv", row.names = FALSE)

V(Data_to_send)$name
get.vertex.attribute(Data_to_send)