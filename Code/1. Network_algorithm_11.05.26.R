...
# Arnaud
 ...
 #graphh <- read_excel("C:/Users/ap115/OneDrive - SOAS University of London/Adria Rius's files - Research collab. AP-AR/Code/edge_list_hs2002_4digit.xlsx") # Arnaud
 
 #hsnames <- read_excel("C:/Users/ap115/OneDrive - SOAS University of London/Adria Rius's files - Research collab. AP-AR/Code/HSCodeandDescription.xlsx", sheet = "HS02")
 #BEC_database <- read_excel("C:/Users/ap115/OneDrive - SOAS University of London/Adria Rius's files - Research collab. AP-AR/Data/BEC database.xlsx") # TO update

 
 
# Adria
 
 #  C:/Users/ap115/OneDrive - SOAS University of London/Adria Rius's files - Research collab. AP-AR/ <- change this
 
graphh <- read_excel("C:/Users/ar86/OneDrive - SOAS University of London/Research collab. AP-AR/Code/edge_list_hs2002_4digit.xlsx")
...
BEC_database <- read_excel("C:/Users/ar86/OneDrive - SOAS University of London/Research collab. AP-AR/Data/BEC database.xlsx") # TO update
...
write.xlsx(Full_net,file = paste("Full_network",product4d,".xlsx",sep=""))
...
#write.xlsx(as.matrix(get.adjacency(gnetwork_new)), rowNames = T, file = paste("gnetwork_filtered",product4d,".xlsx",sep=""))
...
write.xlsx(vdf, rowNames = F, file = paste("C:/Users/ar86/OneDrive - SOAS University of London/Research collab. AP-AR/Output/Vertex_Data",product4d,".xlsx",sep=""))

saveRDS(gnetwork_new, paste("C:/Users/ar86/OneDrive - SOAS University of London/Research collab. AP-AR/Output/PN_links_",product4d,".rds",sep=""))
...
louvain(gnetwork_new,weights = F)
