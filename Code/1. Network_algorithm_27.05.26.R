...
#product4d <- "8501" # Electric motor and generator
#product4d <- "8418" #Refrigerator
#product4d <- "8502" #wind turbine
#product4d <- "8703" # car
...
ggsave(
  file.path(graphs_dir, paste0("heatmapAIPNET_", product_name, ".png")),  
